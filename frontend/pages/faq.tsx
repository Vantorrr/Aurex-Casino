  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Вейджер — это условие отыгрыша бонуса. Например, вейджер x35 означает, что сумму депозита + бонуса нужно прокрутить в ставках 35 раз перед выводом. Прогресс отыгрыша отображается в разделе "Кошелёк".'
      },
      {
